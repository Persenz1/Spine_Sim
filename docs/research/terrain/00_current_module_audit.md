...
> **历史审计快照。** 本文记录 2026-07-29 材料生成改进开始前的模块状态；
> “本轮没有修改”只描述当时的审计阶段，不是当前仓库状态。当前实现以
> [`03_material_generation_implementation.md`](03_material_generation_implementation.md)
> 和 [`../../m1/M1_DATA_DICTIONARY.md`](../../m1/M1_DATA_DICTIONARY.md) 为准。
