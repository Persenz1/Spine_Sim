...
- 解析验收：16/16；
- `tests/test_m3_array.py`：32 passed；
- 结果存储/续跑：6 passed；
- summary 合并：1 passed；
- 全仓：98 passed，另有 12 subtests；
- 现有 M1 地形 0.1 mm smoke：2×2、4×4、6×6 均沉降成功并到达 `path_end`。
...
因此旧的“大能量不守恒”主要是遗漏隐式积分耗散造成的账本错误；当前真正需要关闭
的是粗糙面大阵列的接触稳定化注能、动力学残差和趋势收敛。
...
- `docs/M3_OPEN_ISSUES.md`
- `docs/M3_DESIGN_AND_RUN_PLAN.md`
- `docs/M3_DATA_DICTIONARY.md`
- `docs/M3_TEST_REPORT.md`
- `docs/M3_to_M4_handoff.md`
